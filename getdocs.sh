...
mkdir codedoc
cd codedoc
git submodule add https://$BUILD_BOT_SECRET@github.com/derangedsenators/playerlink.git
echo "Getting Cops and Robbers"
git submodule add https://$BUILD_BOT_SECRET@github.com/derangedsenators/copsandrobbers.git
