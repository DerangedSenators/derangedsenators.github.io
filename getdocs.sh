...
mkdir codedoc
cd codedoc
git submodule add https://$BUILD_BOT_KEY@github.com/derangedsenators/playerlink.git  > /dev/null 2>&1
echo "Getting Cops and Robbers"
git submodule add https://$BUILD_BOT_KEY@github.com/derangedsenators/copsandrobbers.git > /dev/null 2>&1
